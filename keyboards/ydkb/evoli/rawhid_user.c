...
void raw_hid_receive_kb(uint8_t *data, uint8_t length) {
    ...
    if (*command_id == 0xFD) {
         //FD A3: get matrix adc and key. 01 03 of VIA is switch_matrix_state
        if (data[1] == 0xA3) {
            /* FD 03 00 xx xx xx xx xx ... xx xx xx xx xx yy 00 00 ...
               FD 03 10 xx xx xx xx xx ... xx xx xx xx xx yy 00 00 ...
               ...
               FD 03 40 xx xx xx xx xx ... xx xx xx xx xx yy 00 00 ...
               */
